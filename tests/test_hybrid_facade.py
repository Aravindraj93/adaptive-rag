...
class TestHybridFacade(unittest.TestCase):
    def setUp(self):
        ...
        self.chunks = [
            Chunk("c1", "doc1", "REQ_SYS081: SystemController specification.", {"type": "req"}),
            Chunk("c2", "doc1", "ALERT_SYS101: Interface display window.", {"type": "alert"}),
    ...
    def test_basic_hybrid_search(self):
        ...
        # Exact ID match
        results_req = retriever.search("REQ_SYS081", top_k=2)
        ...
        results_query_obj = retriever.search(Query("REQ_SYS081"), top_k=1)
    ...
    def test_cached_hybrid_search(self):
        ...
        first_pass = retriever.search("ALERT_SYS101", top_k=2)
        second_pass = retriever.search("ALERT_SYS101", top_k=2)
